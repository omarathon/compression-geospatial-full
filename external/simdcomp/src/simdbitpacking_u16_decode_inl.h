...
static void simdunpack_u16_il(const __m256i *in, uint16_t *out, const uint32_t bit, __m256i* sum) {
  switch (bit) {
  /* b==0: all-zero block adds 0 to the fused sum (out unused) → no-op (was a
     512B SIMD_nullunpacker16 memset, pure waste on mostly-zero rasters). */
...
static void __SIMD_fastunpack1_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 1) - 1);
...
static void __SIMD_fastunpack2_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 2) - 1);
...
static void __SIMD_fastunpack3_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 3) - 1);
...
static void __SIMD_fastunpack4_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 4) - 1);
...
static void __SIMD_fastunpack5_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 5) - 1);
...
static void __SIMD_fastunpack6_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 6) - 1);
...
static void __SIMD_fastunpack7_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 7) - 1);
...
static void __SIMD_fastunpack8_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 8) - 1);
...
static void __SIMD_fastunpack9_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 9) - 1);
...
static void __SIMD_fastunpack10_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 10) - 1);
...
static void __SIMD_fastunpack11_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 11) - 1);
...
static void __SIMD_fastunpack12_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 12) - 1);
...
static void __SIMD_fastunpack13_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 13) - 1);
...
static void __SIMD_fastunpack14_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 14) - 1);
...
static void __SIMD_fastunpack15_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
  const __m256i mask = _mm256_set1_epi16((1U << 15) - 1);
...
static void __SIMD_fastunpack16_16_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum) {
  (void)_out;
  __m256i InReg = _mm256_loadu_si256(in);
...
static void simdunpack_u16_il_madd(const __m256i *in, uint16_t *out, const uint32_t bit, __m256i* sum) {
  ...
  case 4: __SIMD_fastunpack4_16_madd_il(in, out, sum); break;
  case 5: __SIMD_fastunpack5_16_madd_il(in, out, sum); break;
  case 6: __SIMD_fastunpack6_16_madd_il(in, out, sum); break;
  case 7: __SIMD_fastunpack7_16_madd_il(in, out, sum); break;
  case 8: __SIMD_fastunpack8_16_madd_il(in, out, sum); break;
  case 9: __SIMD_fastunpack9_16_madd_il(in, out, sum); break;
  case 10: __SIMD_fastunpack10_16_madd_il(in, out, sum); break;
  case 11: __SIMD_fastunpack11_16_madd_il(in, out, sum); break;
  case 12: __SIMD_fastunpack12_16_madd_il(in, out, sum); break;
  case 13: __SIMD_fastunpack13_16_madd_il(in, out, sum); break;
  case 14: __SIMD_fastunpack14_16_madd_il(in, out, sum); break;
  case 15: __SIMD_fastunpack15_16_madd_il(in, out, sum); break;
  case 16: __SIMD_fastunpack16_16_madd_il(in, out, sum); break;
  default: break;
  }
}
static void __SIMD_fastunpack1_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack2_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack3_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack4_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack5_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack6_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack7_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack8_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack9_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack10_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack11_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack12_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack13_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack14_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void __SIMD_fastunpack15_16_pfor_madd_il(const __m256i *in, uint16_t *_out, __m256i* sum, const uint16_t *pex, const uint16_t *bm16) {
  (void)_out;
  const uint16_t *_pex = pex;
  __m256i InReg = _mm256_loadu_si256(in);
  __m256i OutReg;
...
static void simdunpack_u16_pfor_il_madd(const __m256i *in, uint16_t *out, const uint32_t bit, __m256i *sum,
                                    const uint16_t *pex, const uint16_t *bm16) {
  switch (bit) {
  case 0: {
    const uint16_t *_pex = pex; int v; (void)in; (void)out;
    ...
    break; }
  case 1: __SIMD_fastunpack1_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 2: __SIMD_fastunpack2_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 3: __SIMD_fastunpack3_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 4: __SIMD_fastunpack4_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 5: __SIMD_fastunpack5_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 6: __SIMD_fastunpack6_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 7: __SIMD_fastunpack7_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 8: __SIMD_fastunpack8_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 9: __SIMD_fastunpack9_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 10: __SIMD_fastunpack10_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 11: __SIMD_fastunpack11_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 12: __SIMD_fastunpack12_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 13: __SIMD_fastunpack13_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 14: __SIMD_fastunpack14_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  case 15: __SIMD_fastunpack15_16_pfor_madd_il(in, out, sum, pex, bm16); break;
  default: break;
  }
}
